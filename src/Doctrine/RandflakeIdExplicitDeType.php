...
/**
 * Randflake ID type class: Explicitly decrypted and encoded type.
 *
 * @author Adam Reece <1108717+Adambean@users.noreply.github.com>
 * @license MIT
 */
final class RandflakeIdExplicitDeType extends RandflakeIdAbstractType
{
    public const NAME = "randflake_id_explicit_de";
