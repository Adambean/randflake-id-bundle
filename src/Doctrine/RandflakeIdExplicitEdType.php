...
/**
 * Randflake ID type class: Explicitly encrypted and decoded type.
 *
 * @author Adam Reece <1108717+Adambean@users.noreply.github.com>
 * @license MIT
 */
final class RandflakeIdExplicitEdType extends RandflakeIdAbstractType
{
    public const NAME = "randflake_id_explicit_ed";
